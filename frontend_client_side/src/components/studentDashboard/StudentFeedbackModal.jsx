...
const StudentFeedbackModal = ( { service_id, modalOpen, setModalOpen } ) => {
  ...
  const handleFeedbackSubmit = async (e) => {
    ...
    const feedback = { user_email, service:service_id, feedback_rating:rating, feedback_description };
  ...
  return (
    <div className=''>
      ...
      overlayClassName="fixed inset-0 bg-dark/60 flex justify-center items-center">
        ...
        <p className="max-w-[750px] mx-auto text-center px-4 opacity-80 text-[15px] lg:text-base mb-1 "> Please rate  our service </p>
